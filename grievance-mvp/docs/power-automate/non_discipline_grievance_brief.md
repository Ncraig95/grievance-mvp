...
- After submission, the API creates the case, renders the non-discipline brief, and continues the normal filing flow used by the app.
...
- Form title:
  `Non-Discipline Grievance Brief`
- Form description:
  `Use this form to prepare and submit a non-discipline grievance brief for intake into the grievance system. After submission, the brief is rendered into the app workflow without grievant email collection or signature routing.`
